...
//  }
  ...
  public Command driveWithSetpointGeneratorFieldRelative(Supplier<ChassisSpeeds> fieldRelativeSpeeds) {
    try {
      return driveWithSetpointGenerator(() -> ChassisSpeeds.fromFieldRelativeSpeeds(fieldRelativeSpeeds.get(), getHeading()));
    } catch (Exception e) {
...
//  }
  ...
  public void setupPathPlanner() {
    ...
    try {
      ...
      final boolean enableFeedforward = true; // set to true if you want to test.
...
//    }
   ...
   */
  // TODO: Customize later to include vision.
  ...
  public void zeroGyroWithAlliance() {
    if (isRedAlliance()) {
      ...
      // might need to change the degree from 0 to 180
    } else {
      zeroGyro();
    }
  }
   ...
   */
  // Should be fine to leave this alone.
